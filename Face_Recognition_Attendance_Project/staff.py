...
class Staff_Details:
    def __init__(self,root):
        ...
        # Top Title Label
        title_label = Label(self.root,text="STAFF DETAILS",font=("times new roman",35,"bold"),bg="white",fg="red")
        ...
        staff_info_frame = LabelFrame(main_frame,bd=2,bg="white",relief=RIDGE,text="Staff Details",font=("times new roman",12,"bold"))
        staff_info_frame.place(x=10,y=5,width=765,height=587)

        # Images Of Left Frame
        img_left1 = Image.open(r"images\staff\staff1.png")
        img_left1 = img_left1.resize((370,150),Image.Resampling.LANCZOS)
        self.photoimg_left1 = ImageTk.PhotoImage(img_left1)
        f_lbl = Label(staff_info_frame,image=self.photoimg_left1)
        f_lbl.place(x=7,y=0,width=370,height=150)

        img_left2 = Image.open(r"images\staff\staff2.png")
        img_left2 = img_left2.resize((365,150),Image.Resampling.LANCZOS)
        self.photoimg_left2 = ImageTk.PhotoImage(img_left2)
        f_lbl = Label(staff_info_frame,image=self.photoimg_left2)
        f_lbl.place(x=383,y=0,width=365,height=150)

        # Staff Information
        staff_info_frame = LabelFrame(staff_info_frame,bd=2,bg="white",relief=RIDGE,text="Staff Personal Information",font=("times new roman",12,"bold"))
        staff_info_frame.place(x=10,y=155,width=740,height=400)

        # Staff Id
        staff_id_Label = Label(staff_info_frame,text="Staff ID :",font=("times new roman",12,"bold"),bg="white")
        staff_id_Label.grid(row=0,column=0,padx=10,pady=5,sticky=W)
        def on_id_focus_in(event):
            if self.var_staffid.get() == "Digits only":
                self.var_staffid.set("")

        def on_id_focus_out(event):
            if not self.var_staffid.get():
                self.var_staffid.set("Digits only")
        ...
        staff_id_entry = ttk.Entry(staff_info_frame,textvariable=self.var_staffid,font=("times new roman",12),width=24,validate="key")
        self.var_staffid.set("Digits only")
        staff_id_entry.config(validate="key",validatecommand=(root.register(validate_id), "%d", "%P"))
        staff_id_entry.bind("<FocusIn>", on_id_focus_in) # Set The Value On Focus
        staff_id_entry.bind("<FocusOut>", on_id_focus_out) # Set The Value Off Focus
        ...
        staff_name_Label = Label(staff_info_frame,text="Staff Name :",font=("times new roman",12,"bold"),bg="white")
        staff_name_Label.grid(row=0,column=2,padx=10,pady=5,sticky=W)

        staff_name_entry = ttk.Entry(staff_info_frame,textvariable=self.var_staffname,font=("times new roman",12),width=24,validate="key", validatecommand=(root.register(validate_text_input), "%P"))
        staff_name_entry.grid(row=0,column=3,padx=10,pady=5,sticky=W)

        # Staff Qualifacation
        qualifacation_Label = Label(staff_info_frame,text="Qualifacation :",font=("times new roman",12,"bold"),bg="white")
        qualifacation_Label.grid(row=1,column=0,padx=10,sticky=W)

        qualifacation_combobox = ttk.Combobox(staff_info_frame,textvariable=self.var_qualification,font=("times new roman",12),state="readonly",width=22)
        qualifacation_combobox["values"]=("Select Qualifacation","10th","12th","Unemployed")
        qualifacation_combobox.current(0)
        qualifacation_combobox.grid(row=1,column=1,padx=10,pady=5,sticky=W)

        # Staff Department
        department_Label = Label(staff_info_frame,text="Department :",font=("times new roman",12,"bold"),bg="white")
        department_Label.grid(row=1,column=2,padx=10,sticky=W)

        department_combobox = ttk.Combobox(staff_info_frame,textvariable=self.var_dept,font=("times new roman",12),state="readonly",width=22)
        ...
        # Duration For Which Staff Is Going To Be In College/School
        duration_Label = Label(staff_info_frame,text="Duration :",font=("times new roman",12,"bold"),bg="white")
        ...
        duration_entry = ttk.Entry(staff_info_frame,textvariable=self.var_duration,font=("times new roman",12),width=24)
        ...
        # Staff Gender
        gender_Label = Label(staff_info_frame,text="Gender :",font=("times new roman",12,"bold"),bg="white")
        gender_Label.grid(row=2,column=2,padx=10,pady=5,sticky=W)

        gender_combobox = ttk.Combobox(staff_info_frame,textvariable=self.var_gender,font=("times new roman",12),state="readonly",width=22)
        ...
        # Staff Date Of Birth
        date_of_birth_Label = Label(staff_info_frame,text="Date Of Birth :",font=("times new roman",12,"bold"),bg="white")
        ...
        date_of_birth_entry = ttk.Entry(staff_info_frame,textvariable=self.var_dob,font=("times new roman",12),width=24)
        ...
        # Staff Email
        email_Label = Label(staff_info_frame,text="Email :",font=("times new roman",12,"bold"),bg="white")
        ...
        email_entry = ttk.Entry(staff_info_frame,textvariable=self.var_email,font=("times new roman",12),width=24)
        ...
        # Staff Phone Number
        phone_number_Label = Label(staff_info_frame,text="Phone Number :",font=("times new roman",12,"bold"),bg="white")
        ...
        phone_number_entry = ttk.Entry(staff_info_frame,textvariable=self.var_phone,font=("times new roman",12),width=24,validate="key")
        self.var_phone.set("10 Digits only")
        ...
        # Staff Address
        address_Label = Label(staff_info_frame,text="Address :",font=("times new roman",12,"bold"),bg="white")
        address_Label.grid(row=4,column=2,padx=10,pady=5,sticky=W)

        address_entry = ttk.Entry(staff_info_frame,textvariable=self.var_address,font=("times new roman",12),width=24)
        address_entry.grid(row=4,column=3,padx=10,pady=5,sticky=W)

        # Staff Experience
        experience_Label = Label(staff_info_frame,text="Experience :",font=("times new roman",12,"bold"),bg="white")
        experience_Label.grid(row=5,column=0,padx=10,pady=5,sticky=W)

        experience_combobox = ttk.Combobox(staff_info_frame,textvariable=self.var_experince,font=("times new roman",12),state="readonly",width=22)
        ...
        # Staff Post
        post_Label = Label(staff_info_frame,text="Post :",font=("times new roman",12,"bold"),bg="white")
        post_Label.grid(row=5,column=2,padx=10,pady=5,sticky=W)

        post_combobox = ttk.Combobox(staff_info_frame,textvariable=self.var_post,font=("times new roman",12),state="readonly",width=22)
        post_combobox["values"]=("Select Post","Senior","Junior","Fresher")
        ...
        radiobtn1 = ttk.Radiobutton(staff_info_frame,variable=self.var_radio1,text="Take Photo Sample",value="Yes")
        radiobtn1.place(x=20,y=235)

        radiobtn2 = ttk.Radiobutton(staff_info_frame,variable=self.var_radio1,text="No Photo Sample",value="No")
        radiobtn2.place(x=170,y=235)

        # Button Frames For Operations
        btn_frame = Frame(staff_info_frame,bd=2,relief=RIDGE,bg="white",border=0)
        ...
        take_photo_sample_button = Button(staff_info_frame,command=self.generate_dataset,cursor="hand2",text="Take/Update Photo Sample",width=35,font=("times new roman",12,"bold"),bg="blue",fg="white",activebackground="blue",activeforeground="white")
        take_photo_sample_button.place(x=210,y=330)


        # Right Frame For Display Staffs Data And Perform Search
        right_frame = LabelFrame(main_frame,bd=2,bg="white",relief=RIDGE,text="staff Details",font=("times new roman",12,"bold"))
        right_frame.place(x=785,y=5,width=740,height=587)

        # Images Of Right Frame
        img_right1 = Image.open(r"images\staff\staff3.jpg")
        ...
        img_right2 = Image.open(r"images\staff\staff4.jpg")
        ...
        # Refresh Button To Refresh The Staff Details Window
        ...
        # Table Frame To Show Staffs Data
        ...
        self.staff_table = ttk.Treeview(table_frame,columns=("id","name","qualification","dept","duration","gender","dob","email","phone","address","experience","post","photo"),xscrollcommand=scroll_x.set,yscrollcommand=scroll_y.set)
...
#-------------------------------------------------- function declaration ---------------------------------------------------------
    ...
    def add_data(self):
        if self.var_staffid.get() == "Digits only" or self.var_staffname.get() == "" or self.var_duration.get() == "MMYY - MMYY" or self.var_qualification.get() == "Select Qualifacation" or self.var_dept.get() == "Select Department" or self.var_experince.get() == "Select Experience" or self.var_post.get() == "Select Post" or self.var_gender.get() == "Select Gender" or self.var_dob.get() == "MM/DD/YY" or self.var_email.get() == "" or self.var_phone.get() == "10 Digits only" or self.var_address.get() == "" or self.var_radio1.get() == "":
            messagebox.showerror("Error","All Fields Are Required",parent=self.root)
        else:
            if(self.validate_fields()):
                try:
                    client = MongoClient('mongodb://localhost:27017/')
                    collection = client['face_recognition_system']['staff_details']
                    collection.create_index([("staff_id", pymongo.ASCENDING)], unique=True) # Create A Unique Index On A Field
                    collection.insert_one({"staff_id":self.var_staffid.get(),"staff_name":self.var_staffname.get(),"qualification":self.var_qualification.get(),"department":self.var_dept.get(),"duration":self.var_duration.get(),"gender":self.var_gender.get(),"date_of_birth":self.var_dob.get(),"email":self.var_email.get(),"phone_number":self.var_phone.get(),"address":self.var_address.get(),"experience":self.var_experince.get(),"post":self.var_post.get(),"photo_sample_status":self.var_radio1.get(),"attendance":"absent","status":"staff"})
                    client.close()
                    # Invoice Code After Successfull Completion Of Operation
                    sound = gtts.gTTS("Staff details has been added successfully",lang = "en")
                    sound.save(r"staff.mp3")
                    playsound.playsound(r"staff.mp3")
                    if os.path.exists("staff.mp3"):
                        os.remove("staff.mp3")
    ...
    def perform_search(self):
        ...
        self.staff_table.delete(*self.staff_table.get_children())  # Clear The Treeview Before Inserting Data
        ...
        for row in result:
            if selected_criteria == "Email":
                ...
                if search_text == str(roll_no).lower():
                    self.staff_table.insert("", END, values=list(row.values()))
                    records_found = True
                ...
                if search_text == str(staff_name).lower():
                    self.staff_table.insert("", END, values=list(row.values()))
                    records_found = True
        client.close()
        ...
        if not records_found:
            self.staff_table.insert("", END, values=("No records found", "", "", "", "", "", "", "", "", "", "", "", "", "", ""))
    ...
    def update_data(self):
        if self.var_staffid.get() == "Digits only" or self.var_staffname.get() == "" or self.var_duration.get() == "MMYY - MMYY" or self.var_qualification.get() == "Select Qualifacation" or self.var_dept.get() == "Select Department" or self.var_experince.get() == "Select Experience" or self.var_post.get() == "Select Post" or self.var_gender.get() == "Select Gender" or self.var_dob.get() == "MM/DD/YY" or self.var_email.get() == "" or self.var_phone.get() == "10 Digits only" or self.var_address.get() == "" or self.var_radio1.get() == "":
            ...
            if(self.validate_fields()):
                try:
                    Update = messagebox.askyesno("Update","Do You Want To Update This Staff Details",parent=self.root)
                    if Update > 0:
                        client = MongoClient('mongodb://localhost:27017/')
                        collection = client['face_recognition_system']['staff_details']
                        collection.update_one({"staff_id":self.var_staffid.get()},{"$set": {"staff_id":self.var_staffid.get(),"staff_name":self.var_staffname.get(),"qualification":self.var_qualification.get(),"department":self.var_dept.get(),"duration":self.var_duration.get(),"gender":self.var_gender.get(),"date_of_birth":self.var_dob.get(),"email":self.var_email.get(),"phone_number":self.var_phone.get(),"address":self.var_address.get(),"experience":self.var_experince.get(),"post":self.var_post.get(),"photo_sample_status":self.var_radio1.get(),"attendance":"absent","status":"staff"}})
                        client.close()
                        # Invoice Code After Successfull Completion Of Operation
                        sound = gtts.gTTS("Staff details has been updated successfully",lang = "en")
                        sound.save(r"staff.mp3")
                        playsound.playsound(r"staff.mp3")
                        if os.path.exists("staff.mp3"):
                            os.remove("staff.mp3")
                        messagebox.showinfo("Success","Staff Details Has Been Updated Successfully",parent=self.root)
                    else:
                        if not Update:
                            return
                    self.fetch_data()
    ...
    def delete_data(self):
        if self.var_staffid.get() == "Digits only":
            ...
            try:
                Delete = messagebox.askyesno("Delete","Do You Want To Delete The Selected Staff Details",parent=self.root)
                if Delete > 0:
                    client = MongoClient('mongodb://localhost:27017/')
                    collection = client['face_recognition_system']['staff_details']
                    collection.delete_one({"staff_id":self.var_staffid.get()})
                    client.close()
                    # Invoice Code After Successfull Completion Of Operation
                    sound = gtts.gTTS("Staff details has been deleted successfully",lang = "en")
                    sound.save(r"staff.mp3")
                    playsound.playsound(r"staff.mp3")
                    if os.path.exists("staff.mp3"):
                        os.remove("staff.mp3")
                    messagebox.showinfo("Success","Staff Details Has Been Deleted Successfully",parent=self.root)
                else:
                    if not Delete:
                        return
                self.fetch_data()
                ...
                try:
                    ...
                    while True:
                        ...
                        if face_cropped(my_frame) is not None:
                            ...
                            file_path = "data/Staff_userid_"+str(id)+"_photosample_"+str(img_id)+"_done.jpg"
